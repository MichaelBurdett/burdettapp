...
export class BlockAvatarEditComponent  implements OnInit {
  ...
  ngOnInit() {
    // this.avatar.getAvatar().subscribe(data => {
      this.avatarData = this.avatar.avatarConfig;
      console.log(this.avatarData);
      this.activeIndexAccessory = this.avatar.accesories.findIndex(x => x === this.avatarData.current_accessory);
      this.activeIndexClothing = this.avatar.clothes.findIndex(x => x === this.avatarData.current_clothes);
      this.activeIndexGlasses = this.avatar.glasses.findIndex(x => x === this.avatarData.current_glasses);
      this.activeIndexGlassOpacity = this.avatar.glassopacities.findIndex(x => x === this.avatarData.current_glassopacity);
      this.activeIndexHair = this.avatar.hairstyles.findIndex(x => x === this.avatarData.current_hairstyle);
      this.activeIndexHairFace = this.avatar.facialhairs.findIndex(x => x === this.avatarData.current_hairface);
      this.activeIndexEyes = this.avatar.eyes.findIndex(x => x === this.avatarData.current_eyes);
      this.activeIndexEyebrows = this.avatar.eyebrows.findIndex(x => x === this.avatarData.current_eyebrows);
      this.activeIndexMouth = this.avatar.mouths.findIndex(x => x === this.avatarData.current_mouth);
      this.activeIndexTattoo = this.avatar.tattoos.findIndex(x => x === this.avatarData.current_tattoo);
    // });
  }
